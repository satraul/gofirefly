...
func (o *ObjectLink0) UnmarshalJSON(bytes []byte) (err error) {
	varObjectLink0 := _ObjectLink0{}

	if err = json.Unmarshal(bytes, &varObjectLink0); err == nil {
		*o = ObjectLink0(varObjectLink0)
	}
