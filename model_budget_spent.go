...
func (o *BudgetSpent) UnmarshalJSON(bytes []byte) (err error) {
	varBudgetSpent := _BudgetSpent{}

	if err = json.Unmarshal(bytes, &varBudgetSpent); err == nil {
		*o = BudgetSpent(varBudgetSpent)
	}
