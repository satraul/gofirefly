...
type _RecurrenceTransactionStore RecurrenceTransactionStore
...
func (o *RecurrenceTransactionStore) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceTransactionStore := _RecurrenceTransactionStore{}

	if err = json.Unmarshal(bytes, &varRecurrenceTransactionStore); err == nil {
		*o = RecurrenceTransactionStore(varRecurrenceTransactionStore)
	}
