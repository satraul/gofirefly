...
type _TransactionSplitStore TransactionSplitStore
...
func (o *TransactionSplitStore) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionSplitStore := _TransactionSplitStore{}

	if err = json.Unmarshal(bytes, &varTransactionSplitStore); err == nil {
		*o = TransactionSplitStore(varTransactionSplitStore)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "piggy_bank_id")
		delete(additionalProperties, "piggy_bank_name")
