...
type _CurrencyStore CurrencyStore
...
func (o *CurrencyStore) UnmarshalJSON(bytes []byte) (err error) {
	varCurrencyStore := _CurrencyStore{}

	if err = json.Unmarshal(bytes, &varCurrencyStore); err == nil {
		*o = CurrencyStore(varCurrencyStore)
	}
