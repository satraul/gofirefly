...
type _RecurrenceUpdate RecurrenceUpdate
...
func (o *RecurrenceUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceUpdate := _RecurrenceUpdate{}

	if err = json.Unmarshal(bytes, &varRecurrenceUpdate); err == nil {
		*o = RecurrenceUpdate(varRecurrenceUpdate)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "repeat_until")
		delete(additionalProperties, "nr_of_repetitions")
		delete(additionalProperties, "apply_rules")
		delete(additionalProperties, "active")
		delete(additionalProperties, "notes")
		delete(additionalProperties, "repetitions")
