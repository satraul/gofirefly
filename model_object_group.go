...
func (o *ObjectGroup) UnmarshalJSON(bytes []byte) (err error) {
	varObjectGroup := _ObjectGroup{}

	if err = json.Unmarshal(bytes, &varObjectGroup); err == nil {
		*o = ObjectGroup(varObjectGroup)
	}
