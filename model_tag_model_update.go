...
type _TagModelUpdate TagModelUpdate
...
func (o *TagModelUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varTagModelUpdate := _TagModelUpdate{}

	if err = json.Unmarshal(bytes, &varTagModelUpdate); err == nil {
		*o = TagModelUpdate(varTagModelUpdate)
	}
