...
type _InsightTransferEntry InsightTransferEntry
...
func (o *InsightTransferEntry) UnmarshalJSON(bytes []byte) (err error) {
	varInsightTransferEntry := _InsightTransferEntry{}

	if err = json.Unmarshal(bytes, &varInsightTransferEntry); err == nil {
		*o = InsightTransferEntry(varInsightTransferEntry)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "difference_float")
		delete(additionalProperties, "in")
		delete(additionalProperties, "in_float")
		delete(additionalProperties, "out")
		delete(additionalProperties, "out_float")
