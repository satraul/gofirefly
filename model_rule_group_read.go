...
type _RuleGroupRead RuleGroupRead
...
func (o *RuleGroupRead) UnmarshalJSON(bytes []byte) (err error) {
	varRuleGroupRead := _RuleGroupRead{}

	if err = json.Unmarshal(bytes, &varRuleGroupRead); err == nil {
		*o = RuleGroupRead(varRuleGroupRead)
	}
