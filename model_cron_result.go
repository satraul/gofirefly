...
func (o *CronResult) UnmarshalJSON(bytes []byte) (err error) {
	varCronResult := _CronResult{}

	if err = json.Unmarshal(bytes, &varCronResult); err == nil {
		*o = CronResult(varCronResult)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "auto_budgets")
