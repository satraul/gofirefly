...
type _TagModelStore TagModelStore
...
func (o *TagModelStore) UnmarshalJSON(bytes []byte) (err error) {
	varTagModelStore := _TagModelStore{}

	if err = json.Unmarshal(bytes, &varTagModelStore); err == nil {
		*o = TagModelStore(varTagModelStore)
	}
