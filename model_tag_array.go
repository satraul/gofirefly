...
func (o *TagArray) UnmarshalJSON(bytes []byte) (err error) {
	varTagArray := _TagArray{}

	if err = json.Unmarshal(bytes, &varTagArray); err == nil {
		*o = TagArray(varTagArray)
	}
