...
type _RuleActionUpdate RuleActionUpdate
...
func (o *RuleActionUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varRuleActionUpdate := _RuleActionUpdate{}

	if err = json.Unmarshal(bytes, &varRuleActionUpdate); err == nil {
		*o = RuleActionUpdate(varRuleActionUpdate)
	}
