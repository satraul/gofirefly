...
type _MetaPagination MetaPagination
...
func (o *MetaPagination) UnmarshalJSON(bytes []byte) (err error) {
	varMetaPagination := _MetaPagination{}

	if err = json.Unmarshal(bytes, &varMetaPagination); err == nil {
		*o = MetaPagination(varMetaPagination)
	}
