...
type _WebhookAttempt WebhookAttempt
...
func (o *WebhookAttempt) UnmarshalJSON(bytes []byte) (err error) {
	varWebhookAttempt := _WebhookAttempt{}

	if err = json.Unmarshal(bytes, &varWebhookAttempt); err == nil {
		*o = WebhookAttempt(varWebhookAttempt)
	}
