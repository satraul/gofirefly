...
type _AvailableBudgetUpdate AvailableBudgetUpdate
...
func (o *AvailableBudgetUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varAvailableBudgetUpdate := _AvailableBudgetUpdate{}

	if err = json.Unmarshal(bytes, &varAvailableBudgetUpdate); err == nil {
		*o = AvailableBudgetUpdate(varAvailableBudgetUpdate)
	}
