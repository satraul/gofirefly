...
func (o *RuleAction) UnmarshalJSON(bytes []byte) (err error) {
	varRuleAction := _RuleAction{}

	if err = json.Unmarshal(bytes, &varRuleAction); err == nil {
		*o = RuleAction(varRuleAction)
	}
