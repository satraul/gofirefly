...
type _PiggyBankArray PiggyBankArray
...
func (o *PiggyBankArray) UnmarshalJSON(bytes []byte) (err error) {
	varPiggyBankArray := _PiggyBankArray{}

	if err = json.Unmarshal(bytes, &varPiggyBankArray); err == nil {
		*o = PiggyBankArray(varPiggyBankArray)
	}
