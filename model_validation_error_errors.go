...
type _ValidationErrorErrors ValidationErrorErrors
...
func (o *ValidationErrorErrors) UnmarshalJSON(bytes []byte) (err error) {
	varValidationErrorErrors := _ValidationErrorErrors{}

	if err = json.Unmarshal(bytes, &varValidationErrorErrors); err == nil {
		*o = ValidationErrorErrors(varValidationErrorErrors)
	}
