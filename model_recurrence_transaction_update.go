...
type _RecurrenceTransactionUpdate RecurrenceTransactionUpdate
...
func (o *RecurrenceTransactionUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceTransactionUpdate := _RecurrenceTransactionUpdate{}

	if err = json.Unmarshal(bytes, &varRecurrenceTransactionUpdate); err == nil {
		*o = RecurrenceTransactionUpdate(varRecurrenceTransactionUpdate)
	}
