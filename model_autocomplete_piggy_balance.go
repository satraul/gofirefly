...
type _AutocompletePiggyBalance AutocompletePiggyBalance
...
func (o *AutocompletePiggyBalance) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompletePiggyBalance := _AutocompletePiggyBalance{}

	if err = json.Unmarshal(bytes, &varAutocompletePiggyBalance); err == nil {
		*o = AutocompletePiggyBalance(varAutocompletePiggyBalance)
	}
