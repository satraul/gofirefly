...
type _CurrencyArray CurrencyArray
...
func (o *CurrencyArray) UnmarshalJSON(bytes []byte) (err error) {
	varCurrencyArray := _CurrencyArray{}

	if err = json.Unmarshal(bytes, &varCurrencyArray); err == nil {
		*o = CurrencyArray(varCurrencyArray)
	}
