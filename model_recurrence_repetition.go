...
type _RecurrenceRepetition RecurrenceRepetition
...
func (o *RecurrenceRepetition) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceRepetition := _RecurrenceRepetition{}

	if err = json.Unmarshal(bytes, &varRecurrenceRepetition); err == nil {
		*o = RecurrenceRepetition(varRecurrenceRepetition)
	}
