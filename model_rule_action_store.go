...
type _RuleActionStore RuleActionStore
...
func (o *RuleActionStore) UnmarshalJSON(bytes []byte) (err error) {
	varRuleActionStore := _RuleActionStore{}

	if err = json.Unmarshal(bytes, &varRuleActionStore); err == nil {
		*o = RuleActionStore(varRuleActionStore)
	}
