...
func (o *UserArray) UnmarshalJSON(bytes []byte) (err error) {
	varUserArray := _UserArray{}

	if err = json.Unmarshal(bytes, &varUserArray); err == nil {
		*o = UserArray(varUserArray)
	}
