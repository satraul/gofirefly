...
type _RuleTriggerStore RuleTriggerStore
...
func (o *RuleTriggerStore) UnmarshalJSON(bytes []byte) (err error) {
	varRuleTriggerStore := _RuleTriggerStore{}

	if err = json.Unmarshal(bytes, &varRuleTriggerStore); err == nil {
		*o = RuleTriggerStore(varRuleTriggerStore)
	}
