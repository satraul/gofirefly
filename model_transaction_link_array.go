...
type _TransactionLinkArray TransactionLinkArray
...
func (o *TransactionLinkArray) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionLinkArray := _TransactionLinkArray{}

	if err = json.Unmarshal(bytes, &varTransactionLinkArray); err == nil {
		*o = TransactionLinkArray(varTransactionLinkArray)
	}
