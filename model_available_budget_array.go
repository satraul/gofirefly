...
type _AvailableBudgetArray AvailableBudgetArray
...
func (o *AvailableBudgetArray) UnmarshalJSON(bytes []byte) (err error) {
	varAvailableBudgetArray := _AvailableBudgetArray{}

	if err = json.Unmarshal(bytes, &varAvailableBudgetArray); err == nil {
		*o = AvailableBudgetArray(varAvailableBudgetArray)
	}
