...
type _PiggyBankEventRead PiggyBankEventRead
...
func (o *PiggyBankEventRead) UnmarshalJSON(bytes []byte) (err error) {
	varPiggyBankEventRead := _PiggyBankEventRead{}

	if err = json.Unmarshal(bytes, &varPiggyBankEventRead); err == nil {
		*o = PiggyBankEventRead(varPiggyBankEventRead)
	}
