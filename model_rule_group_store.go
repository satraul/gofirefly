...
type _RuleGroupStore RuleGroupStore
...
func (o *RuleGroupStore) UnmarshalJSON(bytes []byte) (err error) {
	varRuleGroupStore := _RuleGroupStore{}

	if err = json.Unmarshal(bytes, &varRuleGroupStore); err == nil {
		*o = RuleGroupStore(varRuleGroupStore)
	}
