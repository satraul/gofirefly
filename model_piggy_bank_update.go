...
type _PiggyBankUpdate PiggyBankUpdate
...
func (o *PiggyBankUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varPiggyBankUpdate := _PiggyBankUpdate{}

	if err = json.Unmarshal(bytes, &varPiggyBankUpdate); err == nil {
		*o = PiggyBankUpdate(varPiggyBankUpdate)
	}
