...
type _CurrencyUpdate CurrencyUpdate
...
func (o *CurrencyUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varCurrencyUpdate := _CurrencyUpdate{}

	if err = json.Unmarshal(bytes, &varCurrencyUpdate); err == nil {
		*o = CurrencyUpdate(varCurrencyUpdate)
	}
