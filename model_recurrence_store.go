...
type _RecurrenceStore RecurrenceStore
...
func (o *RecurrenceStore) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceStore := _RecurrenceStore{}

	if err = json.Unmarshal(bytes, &varRecurrenceStore); err == nil {
		*o = RecurrenceStore(varRecurrenceStore)
	}
