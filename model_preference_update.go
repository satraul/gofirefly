...
type _PreferenceUpdate PreferenceUpdate
...
func (o *PreferenceUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varPreferenceUpdate := _PreferenceUpdate{}

	if err = json.Unmarshal(bytes, &varPreferenceUpdate); err == nil {
		*o = PreferenceUpdate(varPreferenceUpdate)
	}
