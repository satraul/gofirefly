...
type _TransactionUpdate TransactionUpdate
...
func (o *TransactionUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionUpdate := _TransactionUpdate{}

	if err = json.Unmarshal(bytes, &varTransactionUpdate); err == nil {
		*o = TransactionUpdate(varTransactionUpdate)
	}
