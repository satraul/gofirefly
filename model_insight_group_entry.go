...
type _InsightGroupEntry InsightGroupEntry
...
func (o *InsightGroupEntry) UnmarshalJSON(bytes []byte) (err error) {
	varInsightGroupEntry := _InsightGroupEntry{}

	if err = json.Unmarshal(bytes, &varInsightGroupEntry); err == nil {
		*o = InsightGroupEntry(varInsightGroupEntry)
	}
