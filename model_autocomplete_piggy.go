...
type _AutocompletePiggy AutocompletePiggy
...
func (o *AutocompletePiggy) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompletePiggy := _AutocompletePiggy{}

	if err = json.Unmarshal(bytes, &varAutocompletePiggy); err == nil {
		*o = AutocompletePiggy(varAutocompletePiggy)
	}
