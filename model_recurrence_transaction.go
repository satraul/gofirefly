...
type _RecurrenceTransaction RecurrenceTransaction
...
func (o *RecurrenceTransaction) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceTransaction := _RecurrenceTransaction{}

	if err = json.Unmarshal(bytes, &varRecurrenceTransaction); err == nil {
		*o = RecurrenceTransaction(varRecurrenceTransaction)
	}
