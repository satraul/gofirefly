...
type _AttachmentStore AttachmentStore
...
func (o *AttachmentStore) UnmarshalJSON(bytes []byte) (err error) {
	varAttachmentStore := _AttachmentStore{}

	if err = json.Unmarshal(bytes, &varAttachmentStore); err == nil {
		*o = AttachmentStore(varAttachmentStore)
	}
