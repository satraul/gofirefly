...
type _TransactionLinkRead TransactionLinkRead
...
func (o *TransactionLinkRead) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionLinkRead := _TransactionLinkRead{}

	if err = json.Unmarshal(bytes, &varTransactionLinkRead); err == nil {
		*o = TransactionLinkRead(varTransactionLinkRead)
	}
