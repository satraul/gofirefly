...
func (o *PageLink) UnmarshalJSON(bytes []byte) (err error) {
	varPageLink := _PageLink{}

	if err = json.Unmarshal(bytes, &varPageLink); err == nil {
		*o = PageLink(varPageLink)
	}
