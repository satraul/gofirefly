...
type _WebhookStore WebhookStore
...
func (o *WebhookStore) UnmarshalJSON(bytes []byte) (err error) {
	varWebhookStore := _WebhookStore{}

	if err = json.Unmarshal(bytes, &varWebhookStore); err == nil {
		*o = WebhookStore(varWebhookStore)
	}
