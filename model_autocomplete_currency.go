...
type _AutocompleteCurrency AutocompleteCurrency
...
func (o *AutocompleteCurrency) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteCurrency := _AutocompleteCurrency{}

	if err = json.Unmarshal(bytes, &varAutocompleteCurrency); err == nil {
		*o = AutocompleteCurrency(varAutocompleteCurrency)
	}
