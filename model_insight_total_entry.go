...
type _InsightTotalEntry InsightTotalEntry
...
func (o *InsightTotalEntry) UnmarshalJSON(bytes []byte) (err error) {
	varInsightTotalEntry := _InsightTotalEntry{}

	if err = json.Unmarshal(bytes, &varInsightTotalEntry); err == nil {
		*o = InsightTotalEntry(varInsightTotalEntry)
	}
