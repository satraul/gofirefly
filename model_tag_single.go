...
func (o *TagSingle) UnmarshalJSON(bytes []byte) (err error) {
	varTagSingle := _TagSingle{}

	if err = json.Unmarshal(bytes, &varTagSingle); err == nil {
		*o = TagSingle(varTagSingle)
	}
