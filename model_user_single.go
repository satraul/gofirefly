...
func (o *UserSingle) UnmarshalJSON(bytes []byte) (err error) {
	varUserSingle := _UserSingle{}

	if err = json.Unmarshal(bytes, &varUserSingle); err == nil {
		*o = UserSingle(varUserSingle)
	}
