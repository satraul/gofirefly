...
type _TransactionLinkUpdate TransactionLinkUpdate
...
func (o *TransactionLinkUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionLinkUpdate := _TransactionLinkUpdate{}

	if err = json.Unmarshal(bytes, &varTransactionLinkUpdate); err == nil {
		*o = TransactionLinkUpdate(varTransactionLinkUpdate)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "link_type_id")
		delete(additionalProperties, "link_type_name")
		delete(additionalProperties, "inward_id")
		delete(additionalProperties, "outward_id")
