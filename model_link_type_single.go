...
type _LinkTypeSingle LinkTypeSingle
...
func (o *LinkTypeSingle) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTypeSingle := _LinkTypeSingle{}

	if err = json.Unmarshal(bytes, &varLinkTypeSingle); err == nil {
		*o = LinkTypeSingle(varLinkTypeSingle)
	}
