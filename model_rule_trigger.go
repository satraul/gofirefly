...
func (o *RuleTrigger) UnmarshalJSON(bytes []byte) (err error) {
	varRuleTrigger := _RuleTrigger{}

	if err = json.Unmarshal(bytes, &varRuleTrigger); err == nil {
		*o = RuleTrigger(varRuleTrigger)
	}
