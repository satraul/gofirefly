...
func (o *Bill) GetNextExpectedMatchDiff() string {
	if o == nil || o.NextExpectedMatchDiff.Get() == nil {
		var ret string
		return ret
	}
...
func (o *Bill) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varBill); err == nil {
		*o = Bill(varBill)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "next_expected_match")
		delete(additionalProperties, "next_expected_match_diff")
		...
		delete(additionalProperties, "pay_dates")
		delete(additionalProperties, "paid_dates")
