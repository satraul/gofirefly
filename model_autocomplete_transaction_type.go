...
type _AutocompleteTransactionType AutocompleteTransactionType
...
func (o *AutocompleteTransactionType) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteTransactionType := _AutocompleteTransactionType{}

	if err = json.Unmarshal(bytes, &varAutocompleteTransactionType); err == nil {
		*o = AutocompleteTransactionType(varAutocompleteTransactionType)
	}
