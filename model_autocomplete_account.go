...
type _AutocompleteAccount AutocompleteAccount
...
func (o *AutocompleteAccount) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteAccount := _AutocompleteAccount{}

	if err = json.Unmarshal(bytes, &varAutocompleteAccount); err == nil {
		*o = AutocompleteAccount(varAutocompleteAccount)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "name_with_balance")
