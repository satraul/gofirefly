...
type AccountStore struct {
	...
	LiabilityDirection NullableString `json:"liability_direction,omitempty"`
...
type _AccountStore AccountStore
...
func NewAccountStore(name string, type_ string) *AccountStore {
	...
	this.Name = name
	this.Type = type_
	var liabilityDirection = "debit"
	this.LiabilityDirection = *NewNullableString(&liabilityDirection)
	var interest string = "0"
	this.Interest = *NewNullableString(&interest)
	var interestPeriod = "monthly"
	this.InterestPeriod = *NewNullableString(&interestPeriod)
	return &this
}
...
func (o *AccountStore) GetLiabilityDirection() string {
	if o == nil || o.LiabilityDirection.Get() == nil {
		var ret string
		return ret
	}
...
// SetLiabilityDirection gets a reference to the given NullableString and assigns it to the LiabilityDirection field.
...
func (o *AccountStore) UnmarshalJSON(bytes []byte) (err error) {
	varAccountStore := _AccountStore{}

	if err = json.Unmarshal(bytes, &varAccountStore); err == nil {
		*o = AccountStore(varAccountStore)
	}
