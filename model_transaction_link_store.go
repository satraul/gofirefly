...
type _TransactionLinkStore TransactionLinkStore
...
func (o *TransactionLinkStore) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionLinkStore := _TransactionLinkStore{}

	if err = json.Unmarshal(bytes, &varTransactionLinkStore); err == nil {
		*o = TransactionLinkStore(varTransactionLinkStore)
	}
