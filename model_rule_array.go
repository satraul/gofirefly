...
func (o *RuleArray) UnmarshalJSON(bytes []byte) (err error) {
	varRuleArray := _RuleArray{}

	if err = json.Unmarshal(bytes, &varRuleArray); err == nil {
		*o = RuleArray(varRuleArray)
	}
