...
type _AvailableBudgetSingle AvailableBudgetSingle
...
func (o *AvailableBudgetSingle) UnmarshalJSON(bytes []byte) (err error) {
	varAvailableBudgetSingle := _AvailableBudgetSingle{}

	if err = json.Unmarshal(bytes, &varAvailableBudgetSingle); err == nil {
		*o = AvailableBudgetSingle(varAvailableBudgetSingle)
	}
