...
type _TransactionSplitUpdate TransactionSplitUpdate
...
func (o *TransactionSplitUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionSplitUpdate := _TransactionSplitUpdate{}

	if err = json.Unmarshal(bytes, &varTransactionSplitUpdate); err == nil {
		*o = TransactionSplitUpdate(varTransactionSplitUpdate)
	}
