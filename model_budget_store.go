...
func (o *BudgetStore) UnmarshalJSON(bytes []byte) (err error) {
	varBudgetStore := _BudgetStore{}

	if err = json.Unmarshal(bytes, &varBudgetStore); err == nil {
		*o = BudgetStore(varBudgetStore)
	}
