...
type _AutocompleteRule AutocompleteRule
...
func (o *AutocompleteRule) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteRule := _AutocompleteRule{}

	if err = json.Unmarshal(bytes, &varAutocompleteRule); err == nil {
		*o = AutocompleteRule(varAutocompleteRule)
	}
