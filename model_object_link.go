...
func (o *ObjectLink) UnmarshalJSON(bytes []byte) (err error) {
	varObjectLink := _ObjectLink{}

	if err = json.Unmarshal(bytes, &varObjectLink); err == nil {
		*o = ObjectLink(varObjectLink)
	}
