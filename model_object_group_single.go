...
type _ObjectGroupSingle ObjectGroupSingle
...
func (o *ObjectGroupSingle) UnmarshalJSON(bytes []byte) (err error) {
	varObjectGroupSingle := _ObjectGroupSingle{}

	if err = json.Unmarshal(bytes, &varObjectGroupSingle); err == nil {
		*o = ObjectGroupSingle(varObjectGroupSingle)
	}
