...
// SetCurrentDebt gets a reference to the given string and assigns it to the CurrentDebt field.
...
// GetLiabilityDirection returns the LiabilityDirection field value if set, zero value otherwise.
func (o *Account) GetLiabilityDirection() string {
	if o == nil || o.LiabilityDirection == nil {
		var ret string
		return ret
	}
	return *o.LiabilityDirection
}
...
func (o *Account) GetLiabilityDirectionOk() (*string, bool) {
	...
	return o.LiabilityDirection, true
}
...
// SetLiabilityDirection gets a reference to the given string and assigns it to the LiabilityDirection field.
func (o *Account) SetLiabilityDirection(v string) {
	o.LiabilityDirection = &v
}
...
func (o Account) MarshalJSON() ([]byte, error) {
	...
	if o.LiabilityDirection != nil {
		toSerialize["liability_direction"] = o.LiabilityDirection
	}
	if o.Interest.IsSet() {
...
func (o *Account) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "account_role")
		...
		delete(additionalProperties, "current_balance_date")
		...
		delete(additionalProperties, "current_debt")
		delete(additionalProperties, "opening_balance_date")
		delete(additionalProperties, "virtual_balance")
		delete(additionalProperties, "include_net_worth")
		delete(additionalProperties, "credit_card_type")
		delete(additionalProperties, "monthly_payment_date")
		delete(additionalProperties, "liability_type")
		delete(additionalProperties, "liability_direction")
		delete(additionalProperties, "interest")
		delete(additionalProperties, "interest_period")
