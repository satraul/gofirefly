...
type _PiggyBankEvent PiggyBankEvent
...
func (o *PiggyBankEvent) UnmarshalJSON(bytes []byte) (err error) {
	varPiggyBankEvent := _PiggyBankEvent{}

	if err = json.Unmarshal(bytes, &varPiggyBankEvent); err == nil {
		*o = PiggyBankEvent(varPiggyBankEvent)
	}
