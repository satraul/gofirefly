...
type _PreferenceArray PreferenceArray
...
func (o *PreferenceArray) UnmarshalJSON(bytes []byte) (err error) {
	varPreferenceArray := _PreferenceArray{}

	if err = json.Unmarshal(bytes, &varPreferenceArray); err == nil {
		*o = PreferenceArray(varPreferenceArray)
	}
