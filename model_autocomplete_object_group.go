...
type _AutocompleteObjectGroup AutocompleteObjectGroup
...
func (o *AutocompleteObjectGroup) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteObjectGroup := _AutocompleteObjectGroup{}

	if err = json.Unmarshal(bytes, &varAutocompleteObjectGroup); err == nil {
		*o = AutocompleteObjectGroup(varAutocompleteObjectGroup)
	}
