...
type _ChartDataSet ChartDataSet
...
func (o *ChartDataSet) UnmarshalJSON(bytes []byte) (err error) {
	varChartDataSet := _ChartDataSet{}

	if err = json.Unmarshal(bytes, &varChartDataSet); err == nil {
		*o = ChartDataSet(varChartDataSet)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "yAxisID")
