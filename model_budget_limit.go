...
func (o *BudgetLimit) UnmarshalJSON(bytes []byte) (err error) {
	varBudgetLimit := _BudgetLimit{}

	if err = json.Unmarshal(bytes, &varBudgetLimit); err == nil {
		*o = BudgetLimit(varBudgetLimit)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "spent")
