...
type _BasicSummaryEntry BasicSummaryEntry
...
func (o *BasicSummaryEntry) UnmarshalJSON(bytes []byte) (err error) {
	varBasicSummaryEntry := _BasicSummaryEntry{}

	if err = json.Unmarshal(bytes, &varBasicSummaryEntry); err == nil {
		*o = BasicSummaryEntry(varBasicSummaryEntry)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "monetary_value")
		...
		delete(additionalProperties, "value_parsed")
		delete(additionalProperties, "local_icon")
