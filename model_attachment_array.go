...
type _AttachmentArray AttachmentArray
...
func (o *AttachmentArray) UnmarshalJSON(bytes []byte) (err error) {
	varAttachmentArray := _AttachmentArray{}

	if err = json.Unmarshal(bytes, &varAttachmentArray); err == nil {
		*o = AttachmentArray(varAttachmentArray)
	}
