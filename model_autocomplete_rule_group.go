...
type _AutocompleteRuleGroup AutocompleteRuleGroup
...
func (o *AutocompleteRuleGroup) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteRuleGroup := _AutocompleteRuleGroup{}

	if err = json.Unmarshal(bytes, &varAutocompleteRuleGroup); err == nil {
		*o = AutocompleteRuleGroup(varAutocompleteRuleGroup)
	}
