...
type _AutocompleteRecurrence AutocompleteRecurrence
...
func (o *AutocompleteRecurrence) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteRecurrence := _AutocompleteRecurrence{}

	if err = json.Unmarshal(bytes, &varAutocompleteRecurrence); err == nil {
		*o = AutocompleteRecurrence(varAutocompleteRecurrence)
	}
