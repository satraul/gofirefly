...
type _LinkTypeUpdate LinkTypeUpdate
...
func (o *LinkTypeUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTypeUpdate := _LinkTypeUpdate{}

	if err = json.Unmarshal(bytes, &varLinkTypeUpdate); err == nil {
		*o = LinkTypeUpdate(varLinkTypeUpdate)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "inward")
		delete(additionalProperties, "outward")
