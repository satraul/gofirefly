...
type _RuleTriggerUpdate RuleTriggerUpdate
...
func (o *RuleTriggerUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varRuleTriggerUpdate := _RuleTriggerUpdate{}

	if err = json.Unmarshal(bytes, &varRuleTriggerUpdate); err == nil {
		*o = RuleTriggerUpdate(varRuleTriggerUpdate)
	}
