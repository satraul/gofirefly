...
type _AvailableBudget AvailableBudget
...
func (o *AvailableBudget) UnmarshalJSON(bytes []byte) (err error) {
	varAvailableBudget := _AvailableBudget{}

	if err = json.Unmarshal(bytes, &varAvailableBudget); err == nil {
		*o = AvailableBudget(varAvailableBudget)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "spent_in_budgets")
		delete(additionalProperties, "spent_outside_budget")
