...
type _RuleGroupUpdate RuleGroupUpdate
...
func (o *RuleGroupUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varRuleGroupUpdate := _RuleGroupUpdate{}

	if err = json.Unmarshal(bytes, &varRuleGroupUpdate); err == nil {
		*o = RuleGroupUpdate(varRuleGroupUpdate)
	}
