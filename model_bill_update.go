...
func (o *BillUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varBillUpdate := _BillUpdate{}

	if err = json.Unmarshal(bytes, &varBillUpdate); err == nil {
		*o = BillUpdate(varBillUpdate)
	}
