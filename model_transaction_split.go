...
type _TransactionSplit TransactionSplit
...
func (o *TransactionSplit) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionSplit := _TransactionSplit{}

	if err = json.Unmarshal(bytes, &varTransactionSplit); err == nil {
		*o = TransactionSplit(varTransactionSplit)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "currency_name")
		delete(additionalProperties, "currency_decimal_places")
		delete(additionalProperties, "foreign_currency_id")
		delete(additionalProperties, "foreign_currency_code")
		delete(additionalProperties, "foreign_currency_symbol")
		delete(additionalProperties, "foreign_currency_decimal_places")
		delete(additionalProperties, "amount")
		delete(additionalProperties, "foreign_amount")
		delete(additionalProperties, "description")
		delete(additionalProperties, "source_id")
		delete(additionalProperties, "source_name")
		delete(additionalProperties, "source_iban")
		...
		delete(additionalProperties, "destination_iban")
		delete(additionalProperties, "destination_type")
		delete(additionalProperties, "budget_id")
		delete(additionalProperties, "budget_name")
		delete(additionalProperties, "category_id")
		delete(additionalProperties, "category_name")
		delete(additionalProperties, "bill_id")
		delete(additionalProperties, "bill_name")
		delete(additionalProperties, "reconciled")
		delete(additionalProperties, "notes")
		delete(additionalProperties, "tags")
		delete(additionalProperties, "internal_reference")
		delete(additionalProperties, "external_id")
		delete(additionalProperties, "original_source")
		delete(additionalProperties, "recurrence_id")
		delete(additionalProperties, "recurrence_total")
		delete(additionalProperties, "recurrence_count")
		delete(additionalProperties, "bunq_payment_id")
		delete(additionalProperties, "import_hash_v2")
		delete(additionalProperties, "sepa_cc")
		delete(additionalProperties, "sepa_ct_op")
		delete(additionalProperties, "sepa_ct_id")
		delete(additionalProperties, "sepa_db")
		delete(additionalProperties, "sepa_country")
		delete(additionalProperties, "sepa_ep")
		delete(additionalProperties, "sepa_ci")
		delete(additionalProperties, "sepa_batch_id")
		delete(additionalProperties, "interest_date")
		delete(additionalProperties, "book_date")
		delete(additionalProperties, "process_date")
		...
		delete(additionalProperties, "zoom_level")
