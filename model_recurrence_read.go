...
type _RecurrenceRead RecurrenceRead
...
func (o *RecurrenceRead) UnmarshalJSON(bytes []byte) (err error) {
	varRecurrenceRead := _RecurrenceRead{}

	if err = json.Unmarshal(bytes, &varRecurrenceRead); err == nil {
		*o = RecurrenceRead(varRecurrenceRead)
	}
