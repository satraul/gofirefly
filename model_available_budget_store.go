...
type _AvailableBudgetStore AvailableBudgetStore
...
func (o *AvailableBudgetStore) UnmarshalJSON(bytes []byte) (err error) {
	varAvailableBudgetStore := _AvailableBudgetStore{}

	if err = json.Unmarshal(bytes, &varAvailableBudgetStore); err == nil {
		*o = AvailableBudgetStore(varAvailableBudgetStore)
	}
