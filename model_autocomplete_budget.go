...
type _AutocompleteBudget AutocompleteBudget
...
func (o *AutocompleteBudget) UnmarshalJSON(bytes []byte) (err error) {
	varAutocompleteBudget := _AutocompleteBudget{}

	if err = json.Unmarshal(bytes, &varAutocompleteBudget); err == nil {
		*o = AutocompleteBudget(varAutocompleteBudget)
	}
