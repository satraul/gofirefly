...
type _SystemInfoData SystemInfoData
...
func (o *SystemInfoData) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInfoData := _SystemInfoData{}

	if err = json.Unmarshal(bytes, &varSystemInfoData); err == nil {
		*o = SystemInfoData(varSystemInfoData)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "php_version")
