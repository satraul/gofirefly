...
type _PiggyBankStore PiggyBankStore
...
func (o *PiggyBankStore) UnmarshalJSON(bytes []byte) (err error) {
	varPiggyBankStore := _PiggyBankStore{}

	if err = json.Unmarshal(bytes, &varPiggyBankStore); err == nil {
		*o = PiggyBankStore(varPiggyBankStore)
	}
