...
type _BudgetLimitStore BudgetLimitStore
...
func (o *BudgetLimitStore) UnmarshalJSON(bytes []byte) (err error) {
	varBudgetLimitStore := _BudgetLimitStore{}

	if err = json.Unmarshal(bytes, &varBudgetLimitStore); err == nil {
		*o = BudgetLimitStore(varBudgetLimitStore)
	}
