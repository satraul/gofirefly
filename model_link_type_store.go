...
type _LinkTypeStore LinkTypeStore
...
func (o *LinkTypeStore) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTypeStore := _LinkTypeStore{}

	if err = json.Unmarshal(bytes, &varLinkTypeStore); err == nil {
		*o = LinkTypeStore(varLinkTypeStore)
	}
