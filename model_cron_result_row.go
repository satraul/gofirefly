...
type _CronResultRow CronResultRow
...
func (o *CronResultRow) UnmarshalJSON(bytes []byte) (err error) {
	varCronResultRow := _CronResultRow{}

	if err = json.Unmarshal(bytes, &varCronResultRow); err == nil {
		*o = CronResultRow(varCronResultRow)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "job_fired")
		delete(additionalProperties, "job_succeeded")
		delete(additionalProperties, "job_errored")
