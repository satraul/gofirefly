...
type _TransactionLink TransactionLink
...
func (o *TransactionLink) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionLink := _TransactionLink{}

	if err = json.Unmarshal(bytes, &varTransactionLink); err == nil {
		*o = TransactionLink(varTransactionLink)
	}
